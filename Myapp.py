...
if choice == "🏠 Home":
    ...
    st.markdown("""
    Welcome to **Get You Summary and Answers**! 🚀

    **Built using Open Source Tech Stack (Llama 3.2:3b, BGE Embeddings, and Qdrant running locally within a Docker Container.)**
...
# Contact Page
    ...
    - **Email:** [developer@example.com](mailto:durgapavan209@gmail.com) ✉️
...
# Footer
st.markdown("---")
st.markdown("© 2025 Document Summarization Application . All rights reserved. 🛡️")
